...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#191919] text-white">
      {/* ===== HEADER (Semi-transparent and Fixed) ===== */}
      <header className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-sm border-b border-white/10">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="lg:hidden bg-[#191919]/95 border-t border-white/10">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full z-0">
          {/* Desktop Video (Check if videos are in the /public/videos folder) */}
          ...
          {/* Mobile Video (Check if videos are in the /public/videos folder) */}
